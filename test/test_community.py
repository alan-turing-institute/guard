...
class TestCommunity(object):
    def test_total_ultrasocietal_traits(self, default_parameters,
                                        basic_community):
        params = default_parameters
        traits = 4
        tile = basic_community()
        tile.ultrasocietal_traits = [True]*traits + [False]*(
            params.n_ultrasocietal_traits-traits)
    ...
    def test_total_military_techs(self, default_parameters, basic_community):
        ...
        tile = basic_community()
        tile.military_techs = (
            [False]*(params.n_military_techs-techs) + [True]*techs
            )
...
class TestMilitaryTechDifussion(object):
    ...
    def test_tech_diffusion(self, custom_parameters, basic_community,
                            advanced_community):
